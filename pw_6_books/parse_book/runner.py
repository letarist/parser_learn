...
if __name__ == '__main__':
    ...
    # process.crawl(Book24Spider)     # при pfgecrt 2 пауков одновременно выпадает ошибка twisted.internet.error.ReactorAlreadyInstalledError: reactor already installed
